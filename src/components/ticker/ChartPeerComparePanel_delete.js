...
import ChartPeerComparePanelUI from './ChartPeerComparePanelUI.js';
import chart_tickers from '../../apiclient/chart_tickers.js';

class ChartPeerComparePanel extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading  : true,
...
export default ChartPeerComparePanel;
